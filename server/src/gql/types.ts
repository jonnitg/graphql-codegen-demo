...
export type ResolversTypes = ResolversObject<{
  ...
  BookChapter: ResolverTypeWrapper<BookChapter>;
...
export type BookResolvers<ContextType = AppContext, ParentType extends ResolversParentTypes['Book'] = ResolversParentTypes['Book']> = ResolversObject<{
  ...
  chapters?: Resolver<Maybe<Array<Maybe<ResolversTypes['BookChapter']>>>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BookChapterResolvers<ContextType = AppContext, ParentType extends ResolversParentTypes['BookChapter'] = ResolversParentTypes['BookChapter']> = ResolversObject<{
